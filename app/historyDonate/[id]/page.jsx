  ...
  return (
    <div className="p-1 w-full overflow-x-hidden">
      <div className="flex items-center mb-3">
        ...
        <h1 className="text-xl font-bold text-[#F26532]">Riwayat Donasi</h1>
      </div>
                ...
                >
                  ...
                  <div className="border-t border-gray-300 mt-1 flex flex-row justify-between items-center">
                    <div className="flex flex-row items-center mt-2">
                      <Link href={`/detailDonatur/${transaksi.id}`} className="text-[#F26532] flex items-center mr-2 bg-gray-50 shadow hover:opacity-50 transition-all p-2 rounded"><Download size={18} className="mr-2" />Kwitansi</Link>
                      <button className="p-2 flex items-center rounded bg-[#F26532] shadow text-white mr-2 hover:opacity-50 transition-all hover:cursor-pointer">
                        <Download className="mr-2" size={18} />Sertifikat
                      </button>
                    </div>
